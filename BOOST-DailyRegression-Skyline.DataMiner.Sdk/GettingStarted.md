...
Open the `BOOST-DailyRegression-Skyline.DataMiner.Sdk.cs` file to write custom installation code. Common actions include creating elements, services, or views.
